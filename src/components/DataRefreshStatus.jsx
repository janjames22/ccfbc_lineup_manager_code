...
export default function DataRefreshStatus({ className = '', lastUpdatedAt, refreshing, status }) {
  ...
  return (
    <div className={`inline-flex min-h-9 max-w-full items-center gap-2 rounded-lg border border-slate-800 bg-slate-900/70 px-3 py-1.5 text-xs font-bold text-slate-300 ${className}`}>
